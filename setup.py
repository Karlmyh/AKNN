...
DISTNAME = "AKNN"
DESCRIPTION = "adaptive k nearest neighbors"
with open("README.md") as f:
    LONG_DESCRIPTION = f.read()
MAINTAINER = "Yuheng Ma"
MAINTAINER_EMAIL = "yma@ruc.edu.cn"
...
class CleanCommand(Clean):
    ...
    def run(self):
        ...
        if os.path.exists("build"):
            shutil.rmtree("build")
        for dirpath, dirnames, filenames in os.walk("AKNN"):
    ...
    class build_ext_subclass(build_ext):
        def finalize_options(self):
            ...
            if self.parallel is None:
                ...
                parallel = os.environ.get("AKNN_BUILD_PARALLEL")
                if parallel:
